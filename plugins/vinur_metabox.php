...
// Add the Properties Meta Boxes
 function add_property_metaboxes() {
    add_meta_box('vinur_casestudy_client', 'Clients', 'vinur_casestudy_client', 'casestudy', 'advanced', 'default');
    add_meta_box('vinur_casestudy_goals', 'Goals', 'vinur_casestudy_goals', 'casestudy', 'advanced', 'default');
    add_meta_box('vinur_casestudy_target_audience', 'Target audience', 'vinur_casestudy_target_audience', 'casestudy', 'advanced', 'default');
    add_meta_box('vinur_casestudy_solution', 'Solution', 'vinur_casestudy_solution', 'casestudy', 'advanced', 'default');
    add_meta_box('vinur_casestudy_results', 'Results', 'vinur_casestudy_results', 'casestudy', 'advanced', 'default');
}

function vinur_casestudy_client() {
    global $post;
...
function vinur_casestudy_goals() {
    global $post;
...
function vinur_casestudy_target_audience() {
    global $post;
...
function vinur_casestudy_solution() {
    global $post;
...
function vinur_casestudy_results() {
    global $post;
...
function vinur_save_casestudy_meta($post_id, $post) {
...
add_action('save_post', 'vinur_save_casestudy_meta', 1, 2); // save the custom fields
?>
