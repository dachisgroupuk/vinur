 ...
 */
add_action('show_user_profile', 'vinur_user_profile',6);
add_action('edit_user_profile', 'vinur_user_profile',6);
add_action('personal_options_update', 'vinur_user_profile_update');
add_action('edit_user_profile_update', 'vinur_user_profile_update');
 ...
 */
function vinur_user_profile($user) {
?>
 ...
 */
function vinur_user_profile_update($user_ID) {
