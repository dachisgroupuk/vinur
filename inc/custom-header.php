...
function vinur_custom_header_setup() {
	...
	// Add a filter to vinur_header_image_width and vinur_header_image_height to change these values.
	define( 'HEADER_IMAGE_WIDTH', apply_filters( 'vinur_header_image_width', 1000 ) );
 ...
 * @since Vinur 1.0
 */
function vinur_admin_header_image() { ?>
	<div id="headimg">
		<?php
...
<?php }
endif; // vinur_admin_header_image
